...
Original file is located at
    https://colab.research.google.com/drive/1O0RJwew5xo7yNShDbrYZTB0Le009Zf7A
"""
...
1. Качество кода и решения (0-35 баллов)
2. Полнота и правильность реализации (0-30 баллов)
3. Документация и комментарии (0-25 баллов)
...
- Поставь итоговую оценку от 0 до 100 баллов
